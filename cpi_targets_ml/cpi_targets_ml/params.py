...
# CACHE PATHS
LOCAL_DATA_PATH = os.path.join(os.path.expanduser('~'), "code", "mabuhalala", "AI", "asa_ml_project", "cpi_targets_ml", "data")
LOCAL_REGISTRY_PATH =  os.path.join(os.path.expanduser('~'), "code", "mabuhalala", "AI", "asa_ml_project", "cpi_targets_ml", "models")
